object DMLstProvArt: TDMLstProvArt
  ...
  object xLstProvArt: TFIBDataSetRO
    ...
    BufferChunks = 32
    SelectSQL.Strings = (
      'select * from lst_compras_prov_articulo'
      '(?empresa, ?ejercicio, ?canal, ?serie, ?articulo_d, ?articulo_h,'
      ' ?prov_d, ?prov_h, ?fecha_d, ?fecha_h, ?alcance, ?canalcal)')
    UniDirectional = False
    Left = 25
    Top = 71
    object xLstProvArtPROVEEDOR: TIntegerField
      DisplayLabel = 'Proveedor'
      FieldName = 'PROVEEDOR'
    end
    object xLstProvArtNOMBRE_PROVEEDOR: TFIBStringField
      DisplayLabel = 'Descripcion'
      FieldName = 'NOMBRE_PROVEEDOR'
      Size = 60
    end
    object xLstProvArtARTICULO: TFIBStringField
      DisplayLabel = 'Articulo'
      FieldName = 'ARTICULO'
      Size = 15
    end
    object xLstProvArtTITULO: TFIBStringField
      DisplayLabel = 'Descripcion'
      FieldName = 'TITULO'
      Size = 256
    end
    object xLstProvArtSUMA_UD: TFloatField
      DisplayLabel = 'Suma Uds.'
      FieldName = 'SUMA_UD'
    end
    object xLstProvArtSUMA_UE: TFloatField
      DisplayLabel = 'Suma Uds. Ext.'
      FieldName = 'SUMA_UE'
    end
    object xLstProvArtVALOR: TFloatField
      DisplayLabel = 'Valor'
      FieldName = 'VALOR'
    end
  end
  ...
  object frProvArt: TfrHYReport
    DataSet = DMMain.QListados
    InitialZoom = pzDefault
    PreviewButtons = [pbZoom, pbLoad, pbSave, pbPrint, pbFind, pbHelp, pbExit]
    OnGetValue = frProvArtGetValue
    KeyField = 'LISTADO'
  ...
  object DSxProvD: TDataSource
    DataSet = xProvD
    Left = 348
    Top = 186
  end
  object xProvH: TFIBDataSetRO
    Database = DMMain.DataBase
    Transaction = TLocal
    AutoTrans = True
    BufferChunks = 32
