object ZFMArtArmazones: TZFMArtArmazones
  Left = 211
  Top = 208
  Width = 512
  Height = 316
  BorderIcons = [biSystemMenu, biMinimize]
  Caption = 'Datos especiales de Armazones'
  Color = clBtnFace
  ...
  object PnlDetalle: TLFPanel
    ...
    object DBGFDetalle: TDBGridFind2000
      ...
      Height = 231
      Align = alClient
      DataSource = ZDMArtArmazones.DSQMArmazonesDet
      TabOrder = 0
