object DMUnidadesExtGes: TDMUnidadesExtGes
  ...
  object QMUnidadesExt: TFIBTableSet
    ...
    DeleteSQL.Strings = (
      ...
      '  LINEA=?old_LINEA ')
    InsertSQL.Strings = (
      'INSERT INTO GES_DETALLES_S_UE'
      
        '  (SERIE,MEDIDA1,MEDIDA2,MEDIDA3,MEDIDA4,PRECIO,RIG,LINEA,EMPRES' +
        'A,EJERCICIO,CANAL,UNIDADES,TIPO)'
      'VALUES'
      
        '  (?SERIE,?MEDIDA1,?MEDIDA2,?MEDIDA3,?MEDIDA4,?PRECIO,?RIG,?LINE' +
        'A,?EMPRESA,?EJERCICIO,?CANAL,?UNIDADES,?TIPO)')
    RefreshSQL.Strings = (
      'SELECT'
      '  *'
