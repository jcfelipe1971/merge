object FRTallas_e: TFRTallas_e
  ...
  object PNLDetalleTallas: TLFPanel
    ...
    object DBGFDetalleTallasPrecios: TDBGridFind2000
      ...
      Height = 214
      Align = alClient
      DataSource = DSQMver_detalles_gr_ed_pc
      TabOrder = 2
    ...
    object DBGFDetalleTallas: TDBGridFind2000
      ...
      Height = 214
      Align = alClient
      DataSource = DSQMver_detalles_gr_ed
      TabOrder = 0
      TitleFont.Charset = DEFAULT_CHARSET
      TitleFont.Color = clWindowText
      TitleFont.Height = -11
    ...
    object TBMain: TLFToolBar
      ...
      object TBStocksTallas: TToolButton
        Left = 333
        Top = 0
        Action = AStockTallas
      end
  ...
  object DSQMver_detalles_gr_ed: TDataSource
    Left = 40
    Top = 64
  end
  ...
  object DSQMver_detalles_gr_ed_pc: TDataSource
    Left = 40
    Top = 96
  end
end
