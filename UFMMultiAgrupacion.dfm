object FMMultiAgrupacion: TFMMultiAgrupacion
  Left = 551
  Top = 195
  BorderIcons = [biSystemMenu, biMinimize]
  BorderStyle = bsSingle
  Caption = 'Multi Agrupaci'#243'n'
  ClientHeight = 220
  ClientWidth = 341
  Color = clBtnFace
  ...
  object TBMain: TLFToolBar
    ...
    object NavMain: THYMNavigator
      ...
      Width = 88
      Height = 22
      DataSource = DMMultiAgrupacion.DSxMultiAgrupacion
  ...
  object PMain: TLFPanel
    ...
    object DBGSeleccion: TDBGridFind2000
      ...
      Transaction = DMMultiAgrupacion.TLocal
      BuscarNums = False
