object DMAgrupacionPedidosVentas: TDMAgrupacionPedidosVentas
  OldCreateOrder = False
  OnCreate = DMAgrupacionPedidosVentasCreate
  ...
  object QMDetalle: TFIBTableSet
    ...
    RefreshSQL.Strings = (
        ...
        'ISTICAS_RESERVADAS, D.ORDEN, D.SU_REFERENCIA,'
      
        '       CP.DOCUMENTO_MUESTRAS, D.LISTO_PARA_PREPARAR, D.LOTE_SIMP' +
        'LE,'
      '       (SELECT UNIDADES'
      ...
      '       AM.REF_PROVEEDOR, ART.LOTES, C.PEDIDO_CLIENTE, D.BARRAS'
    ...
    object QMDetallePEDIDOS_A_PRO: TFloatField
