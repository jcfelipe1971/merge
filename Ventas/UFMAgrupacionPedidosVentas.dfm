inherited FMAgrupacionPedidosVentas: TFMAgrupacionPedidosVentas
  Left = 196
  Top = 237
  Width = 1463
  Height = 480
  ...
  Caption = 'Agrupaci'#243'n de Pedidos de Clientes'
  OldCreateOrder = True
  Position = poDefault
  OnResize = FormResize
  PixelsPerInch = 96
  ...
  inherited PMain: TLFPanel
    ...
    inherited TBMain: TLFToolBar
      ...
      object PNLCliente: TLFPanel
        ...
        object EFCliente: TLFEditFind2000
          ...
          OrdenadoPor.Strings = (
            'CLIENTE')
          Filtros = []
          Entorno = DMAgrupacionPedidosVentas.EBusca
        end
        object DBETitClientes: TLFDbedit
          ...
          DataSource = DMAgrupacionPedidosVentas.DSxClientes
          Enabled = False
          Font.Charset = DEFAULT_CHARSET
      ...
      object TButtRegenera: TToolButton
        Left = 541
        Top = 0
        Hint = 'Genera o Regenera la tabla de agrupaci'#243'n de Pedidos'
        Caption = 'Regenera'
        ImageIndex = 26
      ...
      object TButtMarcarTodasProc: TToolButton
        Left = 695
        Top = 0
        Hint = 'Marcar todas las lineas'
        Caption = 'Marcar todas las lineas'
        DropdownMenu = pmMarcarTodas
        ImageIndex = 94
        Style = tbsDropDown
      end
      object TButtDesmarcarTodasProc: TToolButton
        Left = 731
        Top = 0
        Hint = 'Desmarcar todas las lineas'
        Caption = 'Desmarcar todas las lineas'
        ImageIndex = 147
    ...
    object PCPedidos: TLFPageControl
      Left = 2
      Top = 82
      Width = 1449
      Height = 238
      ...
      object TSAgrupacion: TTabSheet
        Caption = 'Agrupacion de pedidos'
        object DBGFind2000Pedidos: TDBGridFind2000
          Left = 0
          Top = 0
          Width = 1441
          Height = 210
          Align = alClient
          DataSource = DMAgrupacionPedidosVentas.DSQMDetalle
          TabOrder = 0
          ...
          TitleFont.Style = []
          OnCellClick = DBGFind2000PedidosCellClick
          OnDrawColumnCell = DBGFind2000PedidosDrawColumnCell
          OnDblClick = DBGFind2000PedidosDblClick
          OnKeyUp = DBGFind2000PedidosKeyUp
          Insercion = False
          ColumnaInicial = 0
          UsaDicG2K = False
          Changed = False
          ...
          Transaction = DMAgrupacionPedidosVentas.TLocal
          BuscarNums = False
          Campos.Strings = (
            'ID_LOTE')
      ...
      object TSHojaPreparacion: TTabSheet
        ...
        object PNLHojaPreparacion: TLFPanel
          ...
          object DBGFCabeceraHojaPreparacion: TDBGridFind2000
            ...
            Height = 112
            Align = alTop
            DataSource = DMAgrupacionPedidosVentas.DSQMCabeceraPre
            TabOrder = 0
            TitleFont.Charset = DEFAULT_CHARSET
            TitleFont.Color = clWindowText
            TitleFont.Height = -11
          ...
          object DBGFDetalleHojaPreparacion: TDBGridFind2000
            ...
            Height = 88
            Align = alClient
            DataSource = DMAgrupacionPedidosVentas.DSQMDetallePre
            TabOrder = 1
            TitleFont.Charset = DEFAULT_CHARSET
            TitleFont.Color = clWindowText
            TitleFont.Height = -11
    ...
    object PNTotales: TLFPanel
      ...
      object GBPortes: TGroupBox
        ...
        object DBETituloPortes: TLFDbedit
          ...
          Color = clInfoBk
          DataField = 'TITULO'
          DataSource = DMAgrupacionPedidosVentas.DSxPortes
          Enabled = False
          Font.Charset = DEFAULT_CHARSET
          Font.Color = clGrayText
          Font.Height = -11
        ...
        object DBETituloRango: TLFDbedit
          ...
          Color = clInfoBk
          DataField = 'TITULO'
          DataSource = DMAgrupacionPedidosVentas.DSxRangos
          Enabled = False
          Font.Charset = DEFAULT_CHARSET
          Font.Color = clGrayText
          Font.Height = -11
        ...
        object DBETituloIndice: TLFDbedit
          ...
          Color = clInfoBk
          DataField = 'TITULO'
          DataSource = DMAgrupacionPedidosVentas.DSxIndices
          Enabled = False
          Font.Charset = DEFAULT_CHARSET
          Font.Color = clGrayText
          Font.Height = -11
      ...
      object PNLTotalUnidades: TLFPanel
        ...
        object DBETotalUnidades: TLFDbedit
          ...
          DataSource = DMAgrupacionPedidosVentas.DSxUnidadesMarcadas
          TabOrder = 1
        end
      ...
      object GBDireccion: TGroupBox
        ...
        object DBTDireccion: TDBText
          ...
          DataSource = DMAgrupacionPedidosVentas.DSQMDireccion
          ParentColor = False
        end
    ...
    object TBCabeceraAgrupacion: TLFToolBar
      ...
      object PNLCanalDestino: TLFPanel
        ...
        object DBETitCanal: TLFDbedit
          ...
          Color = clInfoBk
          DataField = 'TITULO'
          DataSource = DMAgrupacionPedidosVentas.DSxCanales
          Enabled = False
          Font.Charset = DEFAULT_CHARSET
          Font.Color = clGrayText
          Font.Height = -11
    ...
    object PNLSeleccion: TLFPanel
      ...
      BevelOuter = bvNone
      TabOrder = 3
      object LPedidoSeleccion: TLFLabel
        Left = 12
        Top = 8
        Width = 40
        Height = 13
        Alignment = taRightJustify
        Caption = '&Pedido'
        FocusControl = EPedidoSeleccionDesde
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clWindowText
        Font.Height = -11
        Font.Name = 'MS Sans Serif'
      ...
      object EPedidoSeleccionDesde: TLFEdit
        Left = 56
        Top = 4
        Width = 81
        Height = 21
        TabOrder = 0
        OnExit = EPedidoSeleccionDesdeExit
      ...
      object EPedidoSeleccionHasta: TLFEdit
        Left = 138
        Top = 4
        Width = 81
        Height = 21
      ...
      object EArticuloServir: TLFEditFind2000
        Left = 1124
        Top = 4
        Width = 81
        Height = 21
      ...
      object ECantidadServir: TLFEdit
        Left = 1206
        Top = 4
        Width = 56
        Height = 21
      ...
      object B_SERVIR: TButton
        ...
        Caption = '&Servir'
        TabOrder = 13
        OnClick = B_SERVIRClick
      end
      object CBCalcularPedidosProv: TLFCheckBox
        Left = 853
        Top = 14
        Width = 108
        Height = 17
        Caption = 'Calcular Ped. Prov.'
        ClicksDisabled = False
        ColorCheck = 57088
        TabOrder = 9
        TabStop = True
  ...
  object ALAgrupa: TActionList
    ...
    object AImportarExcel: TAction
      Caption = 'Importar Excel ( Servidas )'
      Hint = 'Importar Excel ( Servidas )'
      ImageIndex = 49
      OnExecute = AImportarExcelExecute
    end
  end
  object pmMarcarTodas: TPopupMenu
    Left = 704
    Top = 32
    object MIMarcarTodas: TMenuItem
      Tag = 1
      Caption = 'Marcar Todas'
      Hint = 'Marcar Todas'
      OnClick = MIMarcarTodasClick
    end
    object MIMarcarTodasStockSuficiente: TMenuItem
      Tag = 2
      Caption = 'Marcar Todas con Stock Suficiente'
      Hint = 'Marcar lineas con stock suficiente para servir la linea completa'
      OnClick = MIMarcarTodasClick
    end
    object MIMarcarTodasServirParcialmente: TMenuItem
      Tag = 3
      Caption = 'Marcar Todas Servir Parcialmente'
      Hint = 
        'Marcar lineas con stock suficiente para servir la linea parcialm' +
        'ente'
      OnClick = MIMarcarTodasClick
    end
  end
