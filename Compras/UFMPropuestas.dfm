inherited FMPropuestas: TFMPropuestas
  Left = 258
  Top = 150
  Width = 976
  Height = 600
  ...
  inherited PMain: TLFPanel
    ...
    inherited TBMain: TLFToolBar
      ...
      inherited NavMain: THYMNavigator
        ...
        DelMessage = #191'Desea borrar la propuesta?'
      ...
      object TButtImprimeListado: TToolButton
        Left = 327
        Top = 0
        Hint = 'Informe Propuesta'
        Caption = 'Informe Propuesta'
        ImageIndex = 14
        ParentShowHint = False
        ShowHint = True
        OnClick = AInformePropuestasExecute
      end
      ...
      object EFBuscaNIFKRI: TLFEditFind2000
        ...
        CampoNum = 'NOMBRE'
        CampoStr = 'RIG'
        CondicionBusqueda = 'tipo='#39'OFP'#39
        Posicion = tpCentrado
    ...
    inherited PCMain: TLFPageControl
      ...
      inherited TSFicha: TTabSheet
        ...
        inherited PEdit: TLFPanel
          ...
          object LBLPlazoEntrega: TLFLabel
            Left = 657
            Top = 24
            Width = 66
            Height = 13
          ...
          object LBLFechaPrevista: TLFLabel
            Left = 395
            Top = 24
            Width = 57
            Height = 13
          ...
          object DBETituloProveedor: TLFDbedit
            ...
            DataSource = DMPropuestas.DSxProveedor
            Font.Charset = DEFAULT_CHARSET
            Font.Color = clGrayText
            Font.Height = -11
            Font.Name = 'MS Sans Serif'
          ...
          object DBETituloEstado: TLFDbedit
            ...
            DataSource = DMPropuestas.DSxInfoActualizada
            Font.Charset = DEFAULT_CHARSET
            Font.Color = clGrayText
            Font.Height = -11
            Font.Name = 'MS Sans Serif'
          ...
          object DBETituloAlmacen: TLFDbedit
            ...
            Color = clInfoBk
            DataField = 'TITULO'
            DataSource = DMPropuestas.DSxAlmacenes
            Enabled = False
            Font.Charset = DEFAULT_CHARSET
            Font.Color = clGrayText
            Font.Height = -11
          ...
          object DBEFormaPago: TLFDbedit
            ...
            Color = clInfoBk
            DataField = 'TITULO'
            DataSource = DMPropuestas.DSxFormasPago
            Enabled = False
            Font.Charset = DEFAULT_CHARSET
            Font.Color = clGrayText
            Font.Height = -11
          ...
          object DBETituloDireccion: TLFDbedit
            ...
            Color = clInfoBk
            DataField = 'TITULO'
            DataSource = DMPropuestas.DSxDirecciones
            Enabled = False
            Font.Charset = DEFAULT_CHARSET
            Font.Color = clGrayText
            Font.Height = -11
          ...
          object DBEProyectoFicha: TLFDbedit
            ...
            Color = clAqua
            DataField = 'TITULO'
            DataSource = DMPropuestas.DSxProyectos
            Enabled = False
            Font.Charset = DEFAULT_CHARSET
            Font.Color = clGrayText
            Font.Height = -11
      ...
      object TSOtros: TTabSheet [1]
        ...
        object SBAProyecto: TSpeedButton
          ...
          Width = 160
          Height = 21
          Hint = 'Doble click para ver los datos del Proyecto'
          GroupIndex = -1
        ...
        object PEdOtros: TLFPanel
          ...
          object DBETitMoneda: TLFDbedit
            ...
            Color = clInfoBk
            DataField = 'TITULO'
            DataSource = DMPropuestas.DSxMonedas
            Enabled = False
            Font.Charset = DEFAULT_CHARSET
            Font.Color = clGrayText
            Font.Height = -11
  ...
  inherited PDetalle: TLFPanel
    ...
    inherited TBDetalle: TLFToolBar
      ...
      inherited NavDetalle: THYMNavigator
        DataSource = DMPropuestas.DSDetalle
        Hints.Strings = ()
      ...
      object TSPieGen: TTabSheet
        ...
        object PPieGenerico: TLFPanel
          ...
          object PNLInfoImportes: TLFPanel
            ...
            object LCuotasIVAyRec: TLFLabel
              Left = 171
              Top = 4
              Width = 68
              Height = 13
  ...
  inherited ALMain: TLFActionList
    Left = 48
    Top = 318
    object AInformePropuestas: TAction
      Category = 'Listados'
      Caption = 'Informe Propuestas'
      Hint = 'Informe Propuestas'
      ImageIndex = 14
      OnExecute = AInformePropuestasExecute
    end
    ...
    object ATraspasoAPropConf: TAction
      Category = 'Procesos'
      Caption = 'Traspaso a Propuesta Confirmada'
      Hint = 'Traspaso a Propuesta Confirmada'
      ImageIndex = 73
      OnExecute = ATraspasoAPropConfExecute
    end
    ...
    object AVisualizarPropFiltradas: TAction
      Category = 'Listados'
      Caption = 'Visualizar Propuestas Filtradas'
      Hint = 'Visualizar Propuestas Filtradas'
      ImageIndex = 14
      OnExecute = AVisualizarPropFiltradasExecute
    end
    object AImprimirPropFiltradas: TAction
      Category = 'Listados'
      Caption = 'Imprimir Propuestas Filtradas'
      Hint = 'Imprimir Propuestas Filtradas'
      ImageIndex = 14
      OnExecute = AImprimirPropFiltradasExecute
    end
    object AVisualizaPropMail: TAction
      Category = 'Listados'
      Caption = 'Visualizar Propuestas e-mail'
      Hint = 'Visualizar Propuestas e-mail'
      ImageIndex = 34
      OnExecute = AVisualizaPropMailExecute
    end
    object AEnviarPropEmail: TAction
      Category = 'Listados;"EnvioMail"'
      Caption = 'Enviar Propuesta por e-mail'
      Hint = 'Enviar Propuesta por e-mail'
      ImageIndex = 34
      OnExecute = AEnviarPropEmailExecute
    end
    object ASep: TAction
      Category = 'Listados'
      Caption = '-'
    end
    object AResumenPropuestas: TAction
      Category = 'Listados'
      Caption = 'Resumen de Propuestas'
      Hint = 'Resumen Propuestas'
      ImageIndex = 14
      OnExecute = AResumenPropuestasExecute
    end
    object AResumenPropuestasFiltradas: TAction
      Category = 'Listados'
      Caption = 'Resumen de Propuestas Filtradas'
      Hint = 'Resumen de Propuestas Filtradas'
      ImageIndex = 14
      OnExecute = AResumenPropuestasFiltradasExecute
    end
    object AImprimirResumenPropuestasFiltradas: TAction
      Category = 'Listados'
      Caption = 'Imprimir Resumen de Propuestas Filtradas'
      Hint = 'Imprimir Resumen de Propuestas Filtradas'
      ImageIndex = 14
      OnExecute = AImprimirResumenPropuestasFiltradasExecute
    end
    ...
    object ATraspasoAPedido: TAction
      ...
      Hint = 'Traspaso a Pedido'
      ImageIndex = 62
      OnExecute = ATraspasoAPedidoExecute
    end
    object ATraspasoMultiCanal: TAction
      Category = 'Procesos'
      Caption = 'Traspaso Propuesta Multi-Canal'
      Hint = 'Traspaso Propuesta Multi-Canal'
      ImageIndex = 86
      OnExecute = ATraspasoMultiCanalExecute
    end
    ...
    object AEnviarPropMailPdf: TAction
      Category = 'Listados;"EnvioMail"'
      Caption = 'Enviar Propuesta por e-mail en Pdf (directo)'
      Hint = 'Enviar Propuesta por e-mail en Pdf'
      ImageIndex = 34
      ShortCut = 49229
      OnExecute = AEnviarPropMailPdfExecute
    end
    ...
    object AConfListadoPropuestas: TAction
      Category = 'Listados;"Configuraci'#243'n R'#225'pida de Listados"'
      Caption = 'Listado de Propuestas'
      Hint = 'Listado de Propuestas'
      ImageIndex = 77
      OnExecute = AConfListadoPropuestasExecute
    end
    object AConfListadoResumenPropuestas: TAction
      Category = 'Listados;"Configuraci'#243'n R'#225'pida de Listados"'
      Caption = 'Listado de Resumen de Propuestas'
      Hint = 'Listado de Resumen de Propuestas'
      ImageIndex = 77
      OnExecute = AConfListadoResumenPropuestasExecute
    end
    ...
    object AAdjuntoPropuesta: TAction
      Category = 'Adjuntos'
      Caption = 'Adjuntos de la Propuesta'
      ImageIndex = 59
      OnExecute = AAdjuntoPropuestaExecute
    end
    ...
    object ARecalcularPrecios: TAction
      ...
      Hint = 'Recalcular Precio de coste y condiciones de las lineas'
      ImageIndex = 92
  ...
  object ALPedidos: TLFActionList
    ...
    object ABuscaNIFKRI: TAction
      ...
      Hint = 'Busca propuestas de proveedores varios'
      ImageIndex = 54
