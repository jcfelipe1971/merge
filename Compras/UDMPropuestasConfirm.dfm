object DMPropuestasConfirm: TDMPropuestasConfirm
  OldCreateOrder = False
  OnCreate = DMDocsPropConfProvCreate
  ...
  object QMDetalle: TFIBTableSet
    ...
    CachedUpdates = False
    DeleteSQL.Strings = (
      'DELETE FROM VER_DETALLE_OCP'
      'WHERE'
      '  ID_DETALLES_E=?old_ID_DETALLES_E ')
    InsertSQL.Strings = (
      'INSERT INTO VER_DETALLE_OCP'
  ...
  object QMCabecera: TFIBTableSet
    ...
    CachedUpdates = False
    DeleteSQL.Strings = (
      'DELETE FROM VER_CABECERAS_OCP'
      'WHERE'
      '  ID_E=?old_ID_E ')
    InsertSQL.Strings = (
      'INSERT INTO VER_CABECERAS_OCP'
        ...
        #13#10'PROYECTO,FECHA_PRE_CAB,MODIFICA_DOC,INVERSION_SUJETO_PASIVO,IM' +
        'PORTE_MINIMO_PORTE,IMPORTE_ICE_TOTAL,S_CUOTA_IMPUESTO_ADICIONAL,' +
        'S_CUOTA_IMP_ADICIONAL_CANAL,EMPAQUETADO_EMPRESA,'#13#10'DIR_RECOGIDA_M' +
        'ANUAL,DIR_ENTREGA_MANUAL,EQUIPO_RECOGIDA,EQUIPO_ENTREGA,MATRICUL' +
        'A_RECOGIDA,MATRICULA_ENTREGA,FECHA_RECOGIDA_MANUAL,FECHA_ENTREGA' +
        '_MANUAL,IDIOMA,ACEPTA_ENTREGA_PARCIAL,'#13#10'USUARIO_CREACION,OBSERVA' +
        'CIONES)'
      'VALUES'
        ...
        'B,?MODIFICA_DOC,?INVERSION_SUJETO_PASIVO,?IMPORTE_MINIMO_PORTE,?' +
        'IMPORTE_ICE_TOTAL,?S_CUOTA_IMPUESTO_ADICIONAL,?S_CUOTA_IMP_ADICI' +
        'ONAL_CANAL,?EMPAQUETADO_EMPRESA,'#13#10'?DIR_RECOGIDA_MANUAL,?DIR_ENTR' +
        'EGA_MANUAL,?EQUIPO_RECOGIDA,?EQUIPO_ENTREGA,?MATRICULA_RECOGIDA,' +
        '?MATRICULA_ENTREGA,?FECHA_RECOGIDA_MANUAL,?FECHA_ENTREGA_MANUAL,' +
        '?IDIOMA,?ACEPTA_ENTREGA_PARCIAL,'#13#10'?USUARIO_CREACION,?OBSERVACION' +
        'ES)')
    RefreshSQL.Strings = (
      'SELECT'
      '  *'
      'FROM VER_CABECERAS_OCP'
      'WHERE'
      '  ID_E=?ID_E ')
    SelectSQL.Strings = (
  ...
  object SPTraspasarA: THYFIBQuery
    ...
    ParamCheck = True
    SQL.Strings = (
      'execute procedure g_traspaso_ocp_prov_a_otro'
