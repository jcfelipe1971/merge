object DMPedidosAProveedor: TDMPedidosAProveedor
  OldCreateOrder = False
  OnCreate = DMDocsPedidoAProvCreate
  ...
  object QMDetalle: TFIBTableSet
    ...
    CachedUpdates = False
    DeleteSQL.Strings = (
      'DELETE FROM VER_DETALLE_PEDIDO_PROV'
      'WHERE'
      '  ID_DETALLES_E=?old_ID_DETALLES_E AND '
      '  ID_E=?old_ID_E ')
    InsertSQL.Strings = (
      'INSERT INTO VER_DETALLE_PEDIDO_PROV'
      
        '  (EMPRESA,'#13#10'EJERCICIO,CANAL,SERIE,TIPO,RIG,LINEA,ALMACEN,ARTICU' +
        'LO,TITULO,UNIDADES,'#13#10'UNIDADES_ORIGINALES,UNIDADES_SERVIDAS,UNIDA' +
        'DES_POR_SERVIR,LINEA_SERVIDA,PRECIO,DESCUENTO,DESCUENTO_2,DESCUE' +
        'NTO_3,P_COSTE,M_MOV_STOCK,'#13#10'PAIS,TIPO_IVA,P_IVA,P_RECARGO,BRUTO,' +
        'I_DESCUENTO,B_IMPONIBLE,ENTRADA,UNIDADES_EXT,NOTAS,PROVEEDOR,COD' +
        'IGO_PROVEEDOR,TITULO_ART_PROV,ID_A,'#13#10'ID_C_A,ID_E,ID_DETALLES_E,F' +
        'ECHA_PRE_DET,FECHA_REC_DET,BULTOS,ORDEN,UNIDADES_SEC,APLICA_UNID' +
        'ADES_SECUNDARIAS,PROYECTO,'#13#10'NOTAS2,CRC_NOTAS,CRC_NOTAS2,FECHA_CO' +
        'NF_KRI,PLAZO_CONFIRM_KRI,ID_DETALLES_E_REGALO,TIPO_UNIDAD_LOGIST' +
        'ICA,TITULO_UNIDAD_LOGISTICA,UNIDADES_LOGISTICAS,ALFA_1,'#13#10'ALFA_2,' +
        'ALFA_3,ALFA_4,ALFA_5,ALFA_6,ALFA_7,ALFA_8,INVERSION_SUJETO_PASIV' +
        'O,DECIMALES_UNIDADES,TIPO_IMPUESTO_ADICIONAL,'#13#10'P_IMPUESTO_ADICIO' +
        'NAL,PESO,PESO_TOTAL,PESO_REAL,PRO_NUM_PLANO,CONTROL_STOCK)'
      'VALUES'
      
        '  (?EMPRESA,'#13#10'?EJERCICIO,?CANAL,?SERIE,?TIPO,?RIG,?LINEA,?ALMACE' +
        'N,?ARTICULO,?TITULO,?UNIDADES,'#13#10'?UNIDADES_ORIGINALES,?UNIDADES_S' +
        'ERVIDAS,?UNIDADES_POR_SERVIR,?LINEA_SERVIDA,?PRECIO,?DESCUENTO,?' +
        'DESCUENTO_2,?DESCUENTO_3,?P_COSTE,?M_MOV_STOCK,'#13#10'?PAIS,?TIPO_IVA' +
        ',?P_IVA,?P_RECARGO,?BRUTO,?I_DESCUENTO,?B_IMPONIBLE,?ENTRADA,?UN' +
        'IDADES_EXT,?NOTAS,?PROVEEDOR,?CODIGO_PROVEEDOR,?TITULO_ART_PROV,' +
        '?ID_A,'#13#10'?ID_C_A,?ID_E,?ID_DETALLES_E,?FECHA_PRE_DET,?FECHA_REC_D' +
        'ET,?BULTOS,?ORDEN,?UNIDADES_SEC,?APLICA_UNIDADES_SECUNDARIAS,?PR' +
        'OYECTO,'#13#10'?NOTAS2,?CRC_NOTAS,?CRC_NOTAS2,?FECHA_CONF_KRI,?PLAZO_C' +
        'ONFIRM_KRI,?ID_DETALLES_E_REGALO,?TIPO_UNIDAD_LOGISTICA,?TITULO_' +
        'UNIDAD_LOGISTICA,?UNIDADES_LOGISTICAS,?ALFA_1,'#13#10'?ALFA_2,?ALFA_3,' +
        '?ALFA_4,?ALFA_5,?ALFA_6,?ALFA_7,?ALFA_8,?INVERSION_SUJETO_PASIVO' +
        ',?DECIMALES_UNIDADES,?TIPO_IMPUESTO_ADICIONAL,'#13#10'?P_IMPUESTO_ADIC' +
        'IONAL,?PESO,?PESO_TOTAL,?PESO_REAL,?PRO_NUM_PLANO,?CONTROL_STOCK' +
        ')')
    RefreshSQL.Strings = (
      'SELECT'
      '  *'
    ...
    UpdateSQL.Strings = (
      'UPDATE VER_DETALLE_PEDIDO_PROV'
      'SET'
      '  EMPRESA=?EMPRESA '
      '  ,EJERCICIO=?EJERCICIO '
      '  ,CANAL=?CANAL '
      ...
      '  ,UNIDADES_POR_SERVIR=?UNIDADES_POR_SERVIR '
      ...
      '  ,TITULO_ART_PROV=?TITULO_ART_PROV '
      '  ,ID_A=?ID_A '
      '  ,ID_C_A=?ID_C_A '
      ...
      '  ,FECHA_CONF_KRI=?FECHA_CONF_KRI '
      '  ,PLAZO_CONFIRM_KRI=?PLAZO_CONFIRM_KRI '
      '  ,ID_DETALLES_E_REGALO=?ID_DETALLES_E_REGALO '
    ...
    Mensajes = False
    TableName = 'VER_DETALLE_PEDIDO_PROV'
    BloqOpt = True
    ...
    object QMDetalleUNIDADES_ORIGINALES: TFloatField
      ...
      OnGetText = QMDetalleUNIDADES_ORIGINALESGetText
    end
    ...
    object QMDetalleUNIDADES_POR_SERVIR: TFloatField
      DisplayLabel = 'Pdte. Recibir'
      FieldName = 'UNIDADES_POR_SERVIR'
      OnGetText = QMDetalleUNIDADES_POR_SERVIRGetText
    end
    ...
    object QMDetalleTITULO_ART_PROV: TFIBStringField
      DisplayLabel = 'Titulo Prov.'
      DisplayWidth = 256
      FieldName = 'TITULO_ART_PROV'
      Size = 256
    end
    ...
    object QMDetalleCLIENTE_ORIGEN_KRI: TStringField
      DisplayLabel = 'Cliente Orig.'
      FieldKind = fkCalculated
      FieldName = 'CLIENTE_ORIGEN_KRI'
      ReadOnly = True
      OnGetText = QMDetalleCLIENTE_ORIGEN_KRIGetText
      Size = 60
      Calculated = True
    end
    object QMDetalleFECHA_CONF_KRI: TDateTimeField
      DisplayLabel = 'Fec. Conf.'
      FieldName = 'FECHA_CONF_KRI'
    end
    object QMDetallePLAZO_CONFIRM_KRI: TDateTimeField
    ...
    object QMDetalleID_DETALLES_E_REGALO: TIntegerField
    ...
    object QMDetallePEDIDOS_A_PROV: TFloatField
  ...
  object QMCabecera: TFIBTableSet
    ...
    CachedUpdates = False
    DeleteSQL.Strings = (
      'DELETE FROM VER_CABECERAS_PEDIDO_PROV'
      'WHERE'
      '  ID_E=?old_ID_E ')
    InsertSQL.Strings = (
      'INSERT INTO VER_CABECERAS_PEDIDO_PROV'
        ...
        'ON,'#13#10'I_FINANCIACION,FORMA_DE_PAGO,SU_REFERENCIA,FECHA_ENTREGA,ID' +
        '_E,FECHA_PRE_CAB,FECHA_REC_CAB,TRANSPORTISTA,FECHA_CONFIRMADA_KR' +
        'I,PLAZO_INICIAL_KRI,'#13#10'PLAZO_CONFIRM_KRI,TIPO_PORTES,POR_PORTES,I' +
        '_PORTES,I_PORTES_CANAL,CAMBIO_FIJO,VALOR_CAMB_FIJO,PROYECTO,NO_A' +
        'GREGAR_LINEAS_KRI,'#13#10'PERMITIR_SUPERAR_IMPORTE_KRI,ID_ORDEN,LINEA_' +
        'FASE,RIG_ORDEN,MODIFICA_DOC,PEDIDO_VALORADO,INVERSION_SUJETO_PAS' +
        'IVO,IMPORTE_MINIMO_PORTE,IMPORTE_ICE_TOTAL,S_CUOTA_IMPUESTO_ADIC' +
        'IONAL,'#13#10'S_CUOTA_IMP_ADICIONAL_CANAL,EMPAQUETADO_EMPRESA,DIR_RECO' +
        'GIDA_MANUAL,DIR_ENTREGA_MANUAL,EQUIPO_RECOGIDA,EQUIPO_ENTREGA,MA' +
        'TRICULA_RECOGIDA,MATRICULA_ENTREGA,FECHA_RECOGIDA_MANUAL,FECHA_E' +
        'NTREGA_MANUAL,'#13#10'IDIOMA,ACEPTA_ENTREGA_PARCIAL,USUARIO_CREACION,P' +
        'EDIDO_RECIBIDO,OBSERVACIONES)'
      'VALUES'
        ...
        ',?SU_REFERENCIA,?FECHA_ENTREGA,?ID_E,?FECHA_PRE_CAB,?FECHA_REC_C' +
        'AB,?TRANSPORTISTA,?FECHA_CONFIRMADA_KRI,?PLAZO_INICIAL_KRI,'#13#10'?PL' +
        'AZO_CONFIRM_KRI,?TIPO_PORTES,?POR_PORTES,?I_PORTES,?I_PORTES_CAN' +
        'AL,?CAMBIO_FIJO,?VALOR_CAMB_FIJO,?PROYECTO,?NO_AGREGAR_LINEAS_KR' +
        'I,'#13#10'?PERMITIR_SUPERAR_IMPORTE_KRI,?ID_ORDEN,?LINEA_FASE,?RIG_ORD' +
        'EN,?MODIFICA_DOC,?PEDIDO_VALORADO,?INVERSION_SUJETO_PASIVO,?IMPO' +
        'RTE_MINIMO_PORTE,?IMPORTE_ICE_TOTAL,?S_CUOTA_IMPUESTO_ADICIONAL,' +
        #13#10'?S_CUOTA_IMP_ADICIONAL_CANAL,?EMPAQUETADO_EMPRESA,?DIR_RECOGID' +
        'A_MANUAL,?DIR_ENTREGA_MANUAL,?EQUIPO_RECOGIDA,?EQUIPO_ENTREGA,?M' +
        'ATRICULA_RECOGIDA,?MATRICULA_ENTREGA,?FECHA_RECOGIDA_MANUAL,?FEC' +
        'HA_ENTREGA_MANUAL,'#13#10'?IDIOMA,?ACEPTA_ENTREGA_PARCIAL,?USUARIO_CRE' +
        'ACION,?PEDIDO_RECIBIDO,?OBSERVACIONES)')
    RefreshSQL.Strings = (
      'SELECT'
      '  *'
    ...
    UpdateRecordTypes = [cusUnmodified, cusModified, cusInserted]
    UpdateSQL.Strings = (
      'UPDATE VER_CABECERAS_PEDIDO_PROV'
      'SET'
      '  EMPRESA=?EMPRESA '
      '  ,EJERCICIO=?EJERCICIO '
      '  ,CANAL=?CANAL '
      ...
      '  ,FECHA_CONFIRMADA_KRI=?FECHA_CONFIRMADA_KRI '
      '  ,PLAZO_INICIAL_KRI=?PLAZO_INICIAL_KRI '
      '  ,PLAZO_CONFIRM_KRI=?PLAZO_CONFIRM_KRI '
      ...
      '  ,PROYECTO=?PROYECTO '
      '  ,NO_AGREGAR_LINEAS_KRI=?NO_AGREGAR_LINEAS_KRI '
      '  ,PERMITIR_SUPERAR_IMPORTE_KRI=?PERMITIR_SUPERAR_IMPORTE_KRI '
      '  ,ID_ORDEN=?ID_ORDEN '
    ...
    ComprobarTabla = False
    Mensajes = False
    TableName = 'VER_CABECERAS_PEDIDO_PROV'
    BloqOpt = True
    TablasBloqueo.Strings = (
      'GES_CABECERAS_E'
      'GES_CABECERAS_E_PED')
    ...
    object QMCabeceraFECHA_CONFIRMADA_KRI: TDateTimeField
      DisplayLabel = 'Fec. Confirm.'
      FieldName = 'FECHA_CONFIRMADA_KRI'
    end
    object QMCabeceraPLAZO_INICIAL_KRI: TDateTimeField
      DisplayLabel = 'Plazo Inicial'
      FieldName = 'PLAZO_INICIAL_KRI'
    end
    object QMCabeceraPLAZO_CONFIRM_KRI: TDateTimeField
      DisplayLabel = 'Plazo Confirm.'
      FieldName = 'PLAZO_CONFIRM_KRI'
    end
    ...
    object QMCabeceraVALOR_CAMB_FIJO_INV: TFloatField
      DisplayLabel = 'Valor. Camb. Fijo Inv.'
    ...
    object QMCabeceraNO_AGREGAR_LINEAS_KRI: TIntegerField
      DisplayLabel = 'Enviado'
      FieldName = 'NO_AGREGAR_LINEAS_KRI'
      OnChange = QMCabeceraNO_AGREGAR_LINEAS_KRIChange
    end
    object QMCabeceraPERMITIR_SUPERAR_IMPORTE_KRI: TIntegerField
      DisplayLabel = 'Perm. Sup. Importe'
    ...
    object QMCabeceraID_ORDEN: TIntegerField
      ...
      FieldName = 'ID_ORDEN'
      OnChange = QMCabeceraID_ORDENChange
    end
    object QMCabeceraLINEA_FASE: TIntegerField
      DisplayLabel = 'Linea Fase'
      FieldName = 'LINEA_FASE'
    end
    object QMCabeceraRIG_ORDEN: TIntegerField
      DisplayLabel = 'RIG Orden'
      FieldName = 'RIG_ORDEN'
    end
    object QMCabeceraDESC_FASE: TStringField
    ...
    object QMCabeceraPEDIDO_RECIBIDO: TIntegerField
      DisplayLabel = 'Ped. Recibido'
      FieldName = 'PEDIDO_RECIBIDO'
    end
  ...
  object xInfoActualizada: TFIBDataSet
    ...
    SelectSQL.Strings = (
      ...
      'FROM VER_CABECERAS_PEDIDO_PROV D'
      'WHERE'
      'D.ID_E = :ID_E')
    UniDirectional = True
    UpdateRecordTypes = [cusUnmodified, cusModified, cusInserted]
  ...
  object xProveedor: TFIBDataSetRO
    ...
    SelectSQL.Strings = (
      ...
      'TIPO_PORTES, POR_PORTES, I_PORTES, PEDIDO_VALORADO, NOTAS, '
      'IMPORTE_MINIMO_PORTE, TRANSPORTISTA, TRANSPORTISTA_RAPIDO,'
