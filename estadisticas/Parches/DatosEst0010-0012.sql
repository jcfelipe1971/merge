...
/*   Date    : 06-may-2005                                                    */
/*   Creator : JLA                                                            */
/*   Descrip.: Consulta de la estadistica 12: Ventas por Cliente y Articulos. */
/*============================================================================*/
...
values (12, 10, 'Ventas por Cliente/Articulo', 2, 'cab.fecha', 'sum(cab.s_bases)',
  'ver_cabeceras_factura cab join ver_detalle_factura det on (det.id_s=cab.id_s) ', 
