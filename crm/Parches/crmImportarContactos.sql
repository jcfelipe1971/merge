...
/*   Date    : 25-Ago-2008                                                    			*/
/*   Creator : Victor                                                         			*/
/*   Desc    : Parxe especial per importar els contactes de tercers				        */
/*======================================================================================*/

set term ^;
commit work^
/* SFG_VICTOR INICI ja existeix *//*
alter TABLE CRM_CONTACTOS add AMBITO CONTADORES DEFAULT 0
commit work

alter TABLE CRM_CONTACTOS add ACTIVITAT_ECONOMICA TEXTOS_MAS_LARGOS
commit work
*//* SFG_VICTOR FINAL ja existeix */

alter table CRM_CONTACTOS_ACCIONES
add DOC_ACCION CONTADORES DEFAULT 0^
commit work^
