object DMLstPropuestas_prov: TDMLstPropuestas_prov
  OldCreateOrder = False
  OnCreate = DMLstPropuestas_provCreate
  OnDestroy = DMLstPropuestas_provDestroy
  Left = 362
  Top = 221
  Height = 667
  Width = 1279
  object frPropuestas: TfrHYReport
    DataSet = DMMain.QListados
    InitialZoom = pzDefault
    PreviewButtons = [pbZoom, pbLoad, pbSave, pbPrint, pbFind, pbHelp, pbExit]
    RebuildPrinter = False
    OnGetValue = frPropuestasGetValue
    OnBeforePrint = frPropuestasEnterRect
    OnEnterRect = frPropuestasEnterRect
    OnUserFunction = frPropuestasUserFunction
    OnPrintReport = frPropuestasPrintReport
    KeyField = 'LISTADO'
  ...
  object QMCabecera: TFIBDataSetRO
    ...
    BufferChunks = 32
    SelectSQL.Strings = (
      'SELECT * FROM VER_CABECERAS_OFP_LST'
      'WHERE'
      'ID_E = ?ID_E')
  ...
  object HYReportMail: THYReportMail
    ...
    Titulo = 'Listado de Propuesta Proveedores E-Mail'
  ...
  object frxPropuestas: TfrxHYReport
    Version = '3.19'
    ...
    ScriptText.Strings = (
      ...
      'end.')
    StoreInDFM = False
    OnBeforePrint = frxPropuestasBeforePrint
    OnGetValue = frxPropuestasGetValue
    OnUserFunction = frxPropuestasUserFunction
