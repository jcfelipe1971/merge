object ProFMHistoricoSerializacion: TProFMHistoricoSerializacion
  Left = 230
  Top = 182
  ...
  object PMain: TLFPanel
    ...
    object TBMain: TLFToolBar
      ...
      object NavMain: THYMNavigator
        ...
        Width = 88
        Height = 22
        DataSource = ProDMHistoricoSerializacion.DSxHistorico
      ...
      object PNLSerie: TLFPanel
        ...
        object EFNSerie: TLFEditFind2000
          ...
          Transaction = ProDMHistoricoSerializacion.TLocal
          BuscarNums = False
          BuscarChars = True
  ...
  object PMListado: TPopupMenu
    ...
    Left = 440
    Top = 136
    object Imprimetrazabilidaddeseries1: TMenuItem
      Action = AImprime
    end
    object N1: TMenuItem
      Caption = '-'
    end
    object Configuracinrpida1: TMenuItem
      Action = AConfig
    end
  end
  object ATraza: TLFActionList
    Images = DMMain.ILMain_Ac
    Reset = False
    Enabled = True
    Changed = False
    ...
    object AImprime: TAction
      Caption = 'Imprime trazabilidad de series'
      ImageIndex = 14
