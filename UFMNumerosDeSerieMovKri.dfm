object FMNumerosDeSerieMovKri: TFMNumerosDeSerieMovKri
  Left = 542
  Top = 302
  Width = 601
  Height = 404
  Caption = 'Nro de Serie - Movimientos entre almacenes'
  Color = clBtnFace
  ...
  object Panel3: TLFPanel
    ...
    object DBGrid1: TDBGrid
      ...
      Align = alClient
      Color = clInfoBk
      DataSource = DMNumerosDeSerieMovKri.DSDisponible
      ReadOnly = True
      TabOrder = 0
  ...
  object Panel4: TLFPanel
    ...
    object DBGrid2: TDBGrid
      ...
      Align = alClient
      Color = clInfoBk
      DataSource = DMNumerosDeSerieMovKri.DSAsignado
      ReadOnly = True
      TabOrder = 0
      TitleFont.Charset = DEFAULT_CHARSET
      TitleFont.Color = clWindowText
