inherited FPregLstAgentesArt: TFPregLstAgentesArt
  Left = 644
  Top = 484
  BorderIcons = [biSystemMenu, biMinimize]
  Caption = 'Estad'#237'sticas de ventas de agentes por art'#237'culo'
  ClientHeight = 293
  ClientWidth = 512
  OldCreateOrder = True
  Position = poDefault
  ...
  inherited PCMain: TLFPageControl
    ...
    object TSAgentes: TTabSheet
      ...
      object DBEArticuloH: TLFDBEdit
        ...
        Color = clInfoBk
        DataField = 'TITULO'
        DataSource = DMLstAgentesArt.DSxArticuloH
        Enabled = False
      ...
      object DBEArticuloD: TLFDBEdit
        ...
        Color = clInfoBk
        DataField = 'TITULO'
        DataSource = DMLstAgentesArt.DSxArticuloD
        Enabled = False
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clGrayText
        Font.Height = -11
      ...
      object DBEAgenteH: TLFDBEdit
        ...
        Color = clInfoBk
        DataField = 'TITULO'
        DataSource = DMLstAgentesArt.DSxAgenteH
        Enabled = False
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clGrayText
        Font.Height = -11
      ...
      object DBEAgenteD: TLFDBEdit
        ...
        Color = clInfoBk
        DataField = 'TITULO'
        DataSource = DMLstAgentesArt.DSxAgenteD
        Enabled = False
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clGrayText
        Font.Height = -11
