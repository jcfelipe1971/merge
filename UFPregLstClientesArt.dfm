inherited FPregLstClientesArt: TFPregLstClientesArt
  Left = 299
  Top = 188
  BorderIcons = [biSystemMenu, biMinimize]
  Caption = 'Estad'#237'sticas de ventas de clientes por art'#237'culo'
  ClientHeight = 293
  ClientWidth = 512
  OldCreateOrder = True
  Position = poDefault
  ...
  inherited PCMain: TLFPageControl
    ...
    object TSClientes: TTabSheet
      ...
      object DBEArticuloH: TLFDBEdit
        ...
        Color = clInfoBk
        DataField = 'TITULO'
        DataSource = DMLstClientesArt.DSxArticuloH
        Enabled = False
      ...
      object DBEArticuloD: TLFDBEdit
        ...
        Color = clInfoBk
        DataField = 'TITULO'
        DataSource = DMLstClientesArt.DSxArticuloD
        Enabled = False
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clGrayText
        Font.Height = -11
      ...
      object DBEClienteH: TLFDBEdit
        ...
        Color = clInfoBk
        DataField = 'TITULO'
        DataSource = DMLstClientesArt.DSxClienteH
        Enabled = False
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clGrayText
        Font.Height = -11
      ...
      object DBEClienteD: TLFDBEdit
        ...
        Color = clInfoBk
        DataField = 'TITULO'
        DataSource = DMLstClientesArt.DSxClienteD
        Enabled = False
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clGrayText
        Font.Height = -11
