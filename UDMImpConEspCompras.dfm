object DMImpConEspCompras: TDMImpConEspCompras
  ...
  object QMDetalle: TFIBTableSet
    ...
    InsertSQL.Strings = (
      'INSERT INTO ART_COND_COM_D'
        ...
        '  (UNID_MINIMAS,UNID_MAXIMAS,PRECIO,RIG,LINEA,DESCUENTO,DESCUENT' +
        'O_2,DESCUENTO_3,EMPRESA,EJERCICIO,CANAL,TIPO)'
      'VALUES'
      
        '  (?UNID_MINIMAS,?UNID_MAXIMAS,?PRECIO,?RIG,?LINEA,?DESCUENTO,?D' +
        'ESCUENTO_2,?DESCUENTO_3,?EMPRESA,?EJERCICIO,?CANAL,?TIPO)')
    RefreshSQL.Strings = (
      'SELECT'
      '  *'
      'FROM ART_COND_COM_D'
