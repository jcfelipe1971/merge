inherited FMMultiTalla: TFMMultiTalla
  Caption = 'Selecci'#243'n Multitalla'
  ...
  inherited PMain: TLFPanel
    inherited TBMain: TLFToolBar
      ...
      object TBMarcarTodos: TToolButton
        Left = 185
        Top = 0
        Hint = 'Marcar todas las tallas'
        Action = AMarcarTodos
      end
      object TBDesmarcarTodos: TToolButton
        Left = 208
        Top = 0
        Hint = 'Desmarcar todas las tallas'
    ...
    object DBGMain: TDBGridFind2000
      ...
      Height = 302
      Align = alClient
      DataSource = DMMultiTalla.DSQMTallas
      ...
      Transaction = DMMultiTalla.TLocal
      BuscarNums = False
