inherited FMECFVentas: TFMECFVentas
  Left = 379
  Top = 212
  Caption = 'ECF - Ventas'
  ClientHeight = 558
  ...
  inherited PMain: TLFPanel
    ...
    inherited TBMain: TLFToolBar
      ...
      inherited NavMain: THYMNavigator
        Width = 176
        DataSource = DMECFVentas.DSQMDocumentos
    ...
    object TBECFVentas: TLFToolBar
      ...
      object PNLFiltroTipoECF: TLFPanel
        ...
        object EFTipoECF: TLFEditFind2000
          ...
          CampoStr = 'TITULO'
          CondicionBusqueda = 
            'TIPO_NCF in ('#39'31'#39', '#39'32'#39', '#39'33'#39', '#39'34'#39', '#39'41'#39', '#39'43'#39', '#39'44'#39', '#39'45'#39', '#39'46' +
            #39', '#39'47'#39')'
          Posicion = tpCentrado
    ...
    object DBGECFVentas: TDBGridFind2000
      Left = 2
      Top = 52
      Width = 1147
      Height = 480
      ...
      TitleFont.Style = []
      OnCellClick = DBGECFVentasCellClick
      OnDblClick = DBGECFVentasDblClick
      Insercion = False
      ColumnaInicial = 0
      UsaDicG2K = True
      Changed = False
      ...
      Transaction = DMECFVentas.TLocal
      BuscarNums = False
