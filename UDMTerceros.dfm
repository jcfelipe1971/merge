object DMTerceros: TDMTerceros
  ...
  object QMTerceros: TFIBTableSet
    ...
    object QMTercerosPOBLACION_DIRECCION: TFIBStringField
      DisplayLabel = 'Cod. Poblaci'#243'n'
    ...
    object QMTercerosDIRECCION_LITERAL: TBlobField
  ...
  object xLoc_T: TFIBDataSetRO
    ...
    SelectSQL.Strings = (
      'SELECT'
      'LOCALIDAD, PAIS, CODPOSTAL, TITULO, PROVINCIA,'
      'ID_LOCAL, C_PAIS /*DJI LRK KRI*/'
  ...
  object xContactosDireccion: TFIBDataSetRO
    Database = DMMain.DataBase
    Transaction = TLocal
    AutoTrans = True
    BufferChunks = 32
    ...
    Left = 32
    Top = 304
    object xContactosDireccionTERCERO: TIntegerField
      DisplayLabel = 'Tercero'
      FieldName = 'TERCERO'
    end
    object xContactosDireccionCONTACTO: TIntegerField
      DisplayLabel = 'Contacto'
      FieldName = 'CONTACTO'
    end
    object xContactosDireccionNOMBRE: TFIBStringField
      DisplayLabel = 'Nombre'
      FieldName = 'NOMBRE'
      Size = 40
    end
    object xContactosDireccionAPELLIDOS: TFIBStringField
      DisplayLabel = 'Apellidos'
      FieldName = 'APELLIDOS'
      Size = 40
    end
    object xContactosDireccionMOVIL: TFIBStringField
      DisplayLabel = 'Movil'
      FieldName = 'MOVIL'
    end
    object xContactosDireccionTELEFONO: TFIBStringField
      DisplayLabel = 'Tel'#233'fono'
      FieldName = 'TELEFONO'
    end
    object xContactosDireccionDIRECCION: TIntegerField
      DisplayLabel = 'Direcci'#243'n'
      FieldName = 'DIRECCION'
    end
  end
  object DSxContactosDireccion: TDataSource
    DataSet = xContactosDireccion
    Left = 128
    Top = 304
  end
