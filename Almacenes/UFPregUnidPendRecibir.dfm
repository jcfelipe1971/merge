inherited FPregUnidPendRecibir: TFPregUnidPendRecibir
  Left = 327
  Top = 220
  HelpContext = 144
  BorderIcons = [biSystemMenu, biMinimize]
  Caption = 'Listado de Unidades Pendientes de Recibir'
  ClientHeight = 500
  ClientWidth = 592
  OldCreateOrder = True
  OnShow = FormShow
    ...
    object PNLInventarioStocks: TLFPanel
      ...
      object GBOrden: TGroupBox
        ...
        object CBOrden: TLFComboBox
          ...
          Items.Strings = (
            'Almacen, Proveedor, Fecha'
            'Almacen, Articulo, Fecha'
            'Almacen, Fecha, Proveedor'
            'Almacen, Rig, Fecha')
        end
      end
    end
